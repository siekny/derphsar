...
//    }
    ...
    public ShopDto(int id, int shop_id, String shop_name, String shop_adress, String shop_description, String shop_profile, String shop_cover, boolean shop_status, boolean status, Date working_time, int u_id, int cat_id) {
        this.id = id;
