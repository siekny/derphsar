...
//                    .and()
                ...
                .authorizeRequests()
                   ...
                   .antMatchers(HttpMethod.DELETE,"/api/v1/shops/**","/api/v1/products/**","/api/v1/promotions/**").hasRole("SHOPKEEPER")
                   .antMatchers(HttpMethod.PUT,"/api/v1/shops/**","/api/v1/products/**","/api/v1/promotions/**").hasRole("SHOPKEEPER")
